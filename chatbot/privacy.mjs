...
export const DEFAULT_POLICY = Object.freeze({
  version: 'somun-consultation-address-20260910', controller: '브로씨앤씨',
  purpose: '렌탈 상담 연락 및 설치 장소 확인',
  optionalPurpose: '',
  retentionDays: null, retentionText: null, privacyContact: null,
  ...
  relationship: 'unconfirmed', recipient: null, recipientPurpose: null,
  recipientRetention: null, contractRef: null, operationsApproved: false,
});
...
export function policyIssues(p) {
  ...
  if(p.partnerCompanies!==undefined){
    ...
    else if(p.relationship==='third_party'&&!p.partnerCompanies.some(v=>v.name===p.recipient))issues.push('recipientNotListed');
  }
  return issues;
}
