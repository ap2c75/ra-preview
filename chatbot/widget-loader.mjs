...
if(!document.getElementById('somun-launcher')){
 ...
 const open=()=>{if(!frame.hasAttribute('src'))frame.src=new URL('widget.html?v=operations-20260911-2',root);frame.hidden=false;launcher.setAttribute('aria-expanded','true');launcher.textContent='상담 닫기';launcher.setAttribute('aria-label','소문 상담 닫기');frame.focus();};
